...
{
    /// <summary>
    /// A generic child class of the <see cref="UOWRulesEngineCore"/>'s <see cref="WorkRule"/> class
    /// that validates an object is null. The rule passes if the target object is null.
    /// 
    /// <seealso cref="NotNullRule"/>
    /// </summary>
	public class NullRule : WorkRule
    {
        private readonly object obj;

        /// <summary>
        /// Default constructor. Instantiates a new <see cref="NullRule"/> object.
        /// </summary>
        /// <param name="ruleName">
        ...
        public NullRule(string ruleName, string message, object obj)
        ...
        /// <summary>
        /// Tests that the target object's value is null during the
